import { FormPreventivoLibero } from '@/components/FormPreventivoLibero'

export const metadata = { title: 'Preventivo Itinerario Libero' }

export default function PreventivoLiberoPage() {
  return (
    <>
      {/* Page header */}
      <section className="relative overflow-hidden bg-brand-deeper py-20">
        ...
        <div className="container-app relative z-10">
          ...
          <p className="text-white/60 max-w-xl">
            Hai già un&apos;idea di percorso? Raccontamelo e costruisco il viaggio cucito addosso a te.
          </p>
        </div>
      </section>
